...
sample_beta1 <- function(y, x, beta0, beta1, beta2, beta3, sigma1, b1) {
  beta1_star <- rnorm(1, beta1, sigma1)
  
  if (beta1_star < 0 | beta1_star > b1) return(beta1)
...
sample_beta2 <- function(y, x, beta0, beta1, beta2, beta3, sigma2, b2) {
  ...
  lrho <- cond_b2(beta0, beta1, beta2=beta2_star, beta3, sigma2, x, y) - 
    cond_b2(beta0, beta1, beta2=beta2, beta3, sigma0, x, y)
...
sample_beta3 <- function(y, x, beta0, beta1, beta2, beta3, sigma3, b3) {
  ...
  lrho <- cond_b3(beta0, beta1, beta2, beta3=beta3_star, sigma0, x, y) - 
    cond_b3(beta0, beta1, beta2, beta3=beta3, sigma0, x, y)
...
run_mcmc = function(dat, beta0, beta1, beta2, beta3,
                            ...
                            s=10, n.reps=10, tune=TRUE, 
                            b0=100, b1=100, b2=100, b3=100, a=.5, b=.5){
  z=unique(dat$store)
  beta0_keep <- matrix(numeric(n.reps), nrow=n.reps, ncol=length(z))
  beta0_keep[1,] <- beta0
  beta1_keep <- matrix(numeric(n.reps), nrow=n.reps, ncol=length(z))
...
res1 = run_mcmc(dat=stores4, beta0=runif(4,-10,10), beta1=runif(4,-10,10), beta2=runif(4,-10,10), beta3=runif(4,-10,10),
                sigma0=10, sigma1=10, sigma2=10, sigma3=10,
                        n.reps=1000, tune=TRUE, a=0.5, b=0.5)
proc.time() - ptm
