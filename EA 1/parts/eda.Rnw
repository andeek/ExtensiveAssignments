...
print(xtable(matrix(rm_store, nrow=6), caption='Store IDs that we exlude for purposes of analysis.', label="tab:exclude", digits=0), include.rownames=FALSE, include.colnames=FALSE)
@
