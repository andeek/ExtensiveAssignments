...
print(xtable(summary(dat), caption='Summary of green bean data. The data was collected between October 2005 and September 2007. The lowest price for green beans was \\$0.07 per unit, while the maximum was \\$0.95 per unit.', label='tab:summary'), include.rownames=FALSE )
@
