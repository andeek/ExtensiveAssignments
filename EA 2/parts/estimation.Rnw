...
&= \left(\lambda_1e^{-\lambda_1 y_i}\right)^{z_{i}}\left(\lambda_2 e^{-\lambda_2 y_i}\right)^{(1-z_{i})}
\end{align*}
...
&= \left(\phi \lambda_1 e^{-\lambda_1 y_i}\right)^{z_{i}}\left((1-\phi) \lambda_2 e^{-\lambda_2 y_i}\right)^{(1-z_{i})}
\end{align*}
and the conditional mass function for the unobserved $Z_i$ is,
\begin{align*}
k_i(z_i|y_i,\lambda_1, \lambda_2,\phi)
&= \frac{\left(\phi \lambda_1 e^{-\lambda_1 y_i}\right)^{z_{i}}\left((1-\phi) \lambda_2 e^{-\lambda_2 y_i}\right)^{(1-z_{i})}}{\phi \lambda_1 e^{-\lambda_1 y_i} + (1-\phi) \lambda_2 e^{-\lambda_2 y_i}}
\end{align*}
