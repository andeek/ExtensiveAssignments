...
<<plot_hetero2, echo=FALSE, fig.height=4, fig.width=6, out.width='\\textwidth', fig.cap='Comparison of expected versus observed flaw counts for each track segment from both the homoegeneous and the hetergeneous models.', fig.show='hold', message=FALSE, fig.pos='ht'>>=
...
ggplot(data=subway.dat.m) +
  ...
  xlab("Track Segment") + ylab("Count") + theme(legend.position="bottom") +
